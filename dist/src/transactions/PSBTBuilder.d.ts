...
export declare class PSBTBuilder extends FeeEstimator {
    ...
    constructor({ address, changeAddress, datasource, feeRate, chain, network, publicKey, outputs, autoAdjustment, instantTradeMode, }: PSBTBuilderOptions);
    toPSBT(): Psbt;
    toHex(): string;
    toBase64(): string;
    /**
...
//# sourceMappingURL=PSBTBuilder.d.ts.map