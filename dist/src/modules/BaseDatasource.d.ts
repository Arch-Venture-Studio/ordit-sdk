...
export declare abstract class BaseDatasource {
    ...
    constructor({ chain, network }: BaseDatasourceOptions);
    /**
     ...
     * @param options List of options to modify the result provided.
     */
    abstract getInscriptions({ creator, owner, mimeType, mimeSubType, outpoint, sort, limit, next, decodeMetadata, }: GetInscriptionsOptions): Promise<Inscription[]>;
    /**
     ...
     * @param options List of options to modify the result provided.
     */
    abstract getTransaction({ txId, ordinals, hex, witness, decodeMetadata, }: GetTransactionOptions): Promise<GetTransactionResponse>;
    /**
