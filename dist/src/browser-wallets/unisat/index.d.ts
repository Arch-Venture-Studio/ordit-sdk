...
import { UnisatGetAddressesOptions, UnisatSignPSBTOptions } from './types';
/**
 ...
 */
declare function getAddresses(network?: BrowserWalletNetwork, chain?: Chain, options?: UnisatGetAddressesOptions): Promise<WalletAddress[]>;
/**
